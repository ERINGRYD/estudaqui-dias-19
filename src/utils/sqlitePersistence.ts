...
// Data validation and repair (now handled by database constraints)
export const validateAndRepairData = (): boolean => {
  // SQLite handles data integrity through constraints and triggers
  return true;
};

export const clearAllData = (): void => {
  console.warn('clearAllData not implemented - use database viewer to manage data');
};